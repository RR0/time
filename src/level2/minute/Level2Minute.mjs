...
import { level2MinuteUnit } from "./Level2MinuteUnit.mjs"

export class Level2Minute extends Level2Component {
  /**
   * @param {Level2ComponentSpec} spec The year spec value
   * @param {TimeUnit} [unit] The year unit (level0TimeUnits.minute by default)
   */
  constructor (spec, unit = level2MinuteUnit) {
    super(spec, unit)
  }
