...
const level2YearUnit = new CalendarUnit(level0Calendar.year.name, Number.MIN_SAFE_INTEGER, Number.MAX_SAFE_INTEGER, level0Calendar.month, new Level1YearValidator())
